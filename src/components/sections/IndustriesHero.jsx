          ...
          <Col lg={7} xl={6}>
            ...
            >
              ...
              <h1 className="cormorant fw-bold mb-4" style={{ 
                ...
                Investing Across Industries.<br />
                <span style={{ color: '#C8A64E' }}>Creating Sustainable Growth.</span>
              </h1>
              ...
              <p className="inter mb-5" style={{ 
                ...
                Sahmora’s investment philosophy is built on identifying diverse industries with strong market potential. Through our commitment to operational excellence, we foster long-term scalability and deliver sustainable value creation across every sector we enter.
              </p>
